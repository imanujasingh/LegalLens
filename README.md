...
## License
This repository does not include a license file by default. If you want a license added (MIT, Apache 2.0, etc.) tell me which one and I will add it.

---

If you want, I can:
- remove the `logs/` directory from the repository and add it to `.gitignore` (recommended),
- add a minimal `docker-compose.yml` with Postgres + Redis for local development,
- add a small `README` section with example Postman collection exported JSON.
